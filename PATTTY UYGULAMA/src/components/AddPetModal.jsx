// erennbhr/pattty/pattty-df8ab6d3def020d5068a132ec11f675ce8fce13a/Yeni klasör/src/components/AddPetModal.jsx
              ...
              <div className="grid grid-cols-2 gap-5">
                  ...
                  <div className="space-y-2">
                       ...
                       <div className="relative">
                           ...
                           <span className="absolute right-4 top-4 text-gray-400 text-xs font-bold">{t('unit_kg')}</span>
                       </div>
                  </div>
              </div>
           </div>
