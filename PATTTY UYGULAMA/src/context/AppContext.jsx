...
export const AppProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (loadedSettings) {
      ...
      // HATA DÜZELTİLDİ: setDarkMode çağrısı kaldırıldı. 
      // Initial darkMode değeri artık sadece useState tarafından, 
      // applyTheme'in yazdığı localStorage.theme'den okunuyor.
