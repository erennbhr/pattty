...
import ExpenseTracker from './ExpenseTracker'; // YENİ
...
const AppContent = () => {
  ...
  const [expenseBackScreen, setExpenseBackScreen] = useState('home'); // YENİ
  ...
  const handleOpenAddPet = () => {
    ...
    // Eğer pet sayısı 1 veya daha fazlaysa ve premium değilse
    if (pets.length >= 1) {
