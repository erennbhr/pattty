...
import {
  ...
  Phone, MapPin, Info, Trash2, Shield, Scale, Crown, Sparkles, X, DollarSign // DollarSign eklendi
} from 'lucide-react';
...
-------------------------------------------------------- */
const SettingsItem = ({ icon: Icon, label, onClick, danger, right, subLabel }) => (
  <div
    onClick={onClick}
    role="button"
...
const AccountSettings = () => {
  ...
  const { darkMode, setDarkMode, notifications, setNotifications, weightUnit, setWeightUnit, currency, setCurrency } = useApp(); // currency eklendi
  ...
  /* --------------------------------------------------------
      UNIT & CURRENCY SELECTION VIEW (GÜNCELLENDİ)
  -------------------------------------------------------- */
