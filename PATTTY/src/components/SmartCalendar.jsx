...
const SmartCalendar = () => {
  ...
  const { showNotification } = useNotification(); // 🟢 DÜZELTME: Destructuring

  const { reminders, setReminders, pets, moodHistory, notifyIfEnabled } = useApp(); // 🟢 EKLENDİ: notifyIfEnabled
