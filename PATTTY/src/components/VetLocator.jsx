...
const VetLocator = ({ onBack }) => {
  ...
  const FilterPanel = () => (
      <div className="absolute inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center animate-in fade-in duration-200">
          <div className="bg-white dark:bg-[#1A1D21] w-full sm:w-96 rounded-t-3xl sm:rounded-3xl p-6 shadow-2xl animate-in slide-in-from-bottom duration-300">
  ...
  return (
    <div className="relative w-full h-full flex flex-col bg-gray-50 dark:bg-black overflow-hidden">
      ...
      {/* ÜST BAR */}
      {!selectedVet && (
        <div className="absolute top-0 left-0 right-0 p-4 pt-safe-top z-10 flex items-center gap-3 pointer-events-none">
      ...
      >
        ...
        <div className="flex flex-col h-full overflow-hidden">
            ...
            {/* Liste */}
            <div className="flex-1 overflow-y-auto px-4 pb-8 space-y-3 scroll-smooth no-scrollbar">
