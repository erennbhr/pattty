...
import { 
  ...
  ChevronRight, MapPin, ScanLine, Lock, DollarSign, Bell 
} from 'lucide-react';
import { useLanguage } from '../context/LanguageContext';
import { useApp } from '../context/AppContext';
import { usePremium } from '../context/PremiumContext'; 
// import InteractiveSleepingPet from './InteractiveSleepingPet'; // ❌ KALDIRILDI
import { calculateAge, generateID } from '../utils/helpers';
import PaywallModal from './PaywallModal'; 
import LostPetAlert from './LostPetAlert';

// YENİ: Pet görseli için basit bir bileşen
const PetImageDisplay = ({ pet, className }) => {
    ...
    // Görsel yoksa türüne göre bir emoji gösterelim
...
const Dashboard = ({ setPet, openAddModal, onOpenVetLocator, onOpenFoodScan, onOpenExpense }) => {
    ...
    const handleExpenseClick = () => {
        // Feature: 'expense_charts' (Yeni Eklendi)
    ...
    if (!activePet) return (
        <div className="h-full flex flex-col items-center justify-center text-center p-8 space-y-8 relative overflow-hidden animate-in fade-in">
            ...
            {/* 🟡 DEĞİŞİKLİK: InteractiveSleepingPet yerine PetImageDisplay (Boş durumda emoji gösterir) */}
    ...
    return (
        <div className="p-6 space-y-6 animate-in slide-in-from-right-4 relative pb-32">
            ...
            <div className="space-y-4">
                ...
                {/* MASRAF TAKİBİ BANNERI (PREMIUM KONTROLLÜ) */}
                <div 
            ...
            <div className="space-y-4">
                ...
                <div className="grid gap-4">
                    {pets.map((pet) => (
                        ...
                        >
                            {/* 🟡 DEĞİŞİKLİK: InteractiveSleepingPet yerine PetImageDisplay */}
