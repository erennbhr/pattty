        ...
        return (
            <div className="space-y-4 animate-in slide-in-from-right">
                <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl p-6 text-white text-center shadow-lg mb-6">
                    ...
                    <h2 className="text-2xl font-bold">Oyun Alanı</h2>
                    <p className="opacity-90 text-sm">Puan topla, eğlen!</p>
                </div>

                <div className="grid grid-cols-1 gap-4">
                    <GameCard 
                        title="Ödül Avcısı" 
                        desc="Reflekslerini test et!" 
                        icon={Bone} 
                        color="bg-orange-500" 
        ...
        <div className="w-full h-full bg-gray-900 relative flex flex-col items-center justify-center text-white">
            ...
            {!isPlaying ? (
                <div className="text-center space-y-4 z-10 p-6 bg-white/10 backdrop-blur-md rounded-3xl border border-white/20">
                    <h3 className="text-2xl font-bold">{timeLeft === 0 ? 'Süre Bitti!' : 'Ödül Avcısı'}</h3>
                    <p className="text-gray-300">Skorun: <span className="text-yellow-400 font-bold text-xl">{score}</span></p>
        ...
        <div className="w-full h-full bg-indigo-900 flex flex-col items-center justify-center p-4">
            ...
            {isGameOver ? (
                <div className="text-center text-white animate-in zoom-in">
                    ...
                    <h3 className="text-3xl font-bold mb-2">Tebrikler!</h3>
                    <p className="mb-6 opacity-80">{moves} hamlede bitirdin.</p>
                    <button onClick={initializeGame} className="bg-white text-indigo-900 px-6 py-3 rounded-xl font-bold">Tekrar Oyna</button>
                </div>
            ) : (
...
const RPSGame = () => {
    ...
    const choices = [
        { id: 'rock', icon: Square, color: 'text-gray-400', label: 'Taş' },
        { id: 'paper', icon: Scroll, color: 'text-yellow-200', label: 'Kağıt' },
        { id: 'scissors', icon: Scissors, color: 'text-red-400', label: 'Makas' }
    ];
    ...
    return (
        <div className="w-full h-full bg-gray-800 flex flex-col items-center justify-center p-6 text-white">
            ...
            <div className="flex gap-8 mb-8 text-xl font-bold font-mono">
                ...
                <div className="text-center">
                    <p className="text-xs text-gray-400 mb-1">PATTTY</p>
            ...
            {playerChoice ? (
                ...
                <div className="text-center space-y-6 animate-in zoom-in">
                    <div className="flex justify-center items-center gap-6">
                         ...
                         <div className="flex flex-col items-center">
                             ...
                             <span className="text-sm">Pattty</span>
                         </div>
                    </div>
                    
                    <h2 className="text-3xl font-extrabold uppercase">
                        {result === 'win' && <span className="text-green-400">Kazandın! 🎉</span>}
                        {result === 'lose' && <span className="text-red-400">Kaybettin 😔</span>}
                        {result === 'draw' && <span className="text-gray-400">Berabere 🤝</span>}
                    </h2>
                ...
                <div className="space-y-6 text-center w-full">
                    <h3 className="text-xl font-bold mb-6">Seçimini Yap</h3>
